  ...
  return (
    <footer>
      <div className={styles.footer_desktop}>
                ...
                <g>
                  ...
                  <g transform="translate(144.000000, 0.000000)">
                    <g transform="translate(18.000000, 18.000000)">
                      <mask fill="white">
                        <use xlinkHref="#footer-desktop-logo-path-1" />
                      </mask>
                      <use
                        fill="#F34747"
                        fillRule="nonzero"
                        transform="translate(17.000000, 17.000000) rotate(-360.000000) translate(-17.000000, -17.000000) "
                        xlinkHref="#footer-desktop-logo-path-1"
                      />
                    </g>
                    <g>
                      <mask fill="white">
                        <use xlinkHref="#footer-desktop-logo-path-3" />
                      </mask>
                      <use
                        fill="#00DDB3"
                        fillRule="nonzero"
                        transform="translate(17.000000, 17.000000) rotate(-360.000000) translate(-17.000000, -17.000000) "
                        xlinkHref="#footer-desktop-logo-path-3"
                      />
                    </g>
                    <mask fill="white">
                      <use xlinkHref="#footer-desktop-logo-path-5" />
                    </mask>
                    <use
                      fill="#333333"
                      fillRule="nonzero"
                      xlinkHref="#footer-desktop-logo-path-5"
                    />
                  </g>
                </g>
              </g>
        ...
        <div>
          <h6 className={styles.footer_heading}>General</h6>
          <a className={styles.footer_link} href="/">
            Notice
          </a>
          <a className={styles.footer_link} href="/">
        ...
        <div>
          <h6 className={styles.footer_heading}>Resources</h6>
          <a className={styles.footer_link} href="/">
            Help
          </a>
          <a className={styles.footer_link} href="/">
